...
insert into employee values (1, 1, 'parth', 'patil', 'Team Lead', 100000, '2021-07-26');
insert into employee values (2, 6, 'pranali', 'ahuja', 'Project Manager', 150000, '2020-04-17');
