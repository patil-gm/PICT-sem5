...
public:
    ...
    void sjf()
    {
        int complete = 0, time = 0, min_time = 9999, shortest = 0, finish_time = 0;
        bool check = false;
        ...
        while (complete != n)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                if ((at[i] <= time) && (rembt[i] < min_time) && rembt[i] > 0)
                {
                    min_time = rembt[i];
                    shortest = i;
                    check = true;
    ...
    void priority()
    {
        ...
        // for (int k = 0; k < n; k++)
        // {
        //     wait_time[k] = burst_time[k] - arrival_time[k];
        //     total_wait += wait_time[k];
        // }
